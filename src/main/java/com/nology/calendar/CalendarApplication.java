...
public class CalendarApplication {
	...
	public static void main(String[] args) {
		...
		Calendar seanCalendar = Sean.setDailyBound(LocalTime.of(8, 0), LocalTime.of(18, 30));
		...
		Calendar ruthCalendar = Ruth.setDailyBound(LocalTime.of(7, 0), LocalTime.of(19, 30));
		ruthCalendar.createAppointment("Monthly team meeting", AppointmentLength.SIXTY, LocalTime.of(11, 30));
		...
		Calendar danielCalendar = Daniel.setDailyBound(LocalTime.of(9, 0), LocalTime.of(16, 0));
		danielCalendar.createAppointment("Breakfast with Client", AppointmentLength.SIXTY, LocalTime.of(12, 0));
		danielCalendar.createAppointment("Lunch", AppointmentLength.FIFTEEN, LocalTime.of(14, 0));
		...
		System.out.println(Sean.compareCalendar(List.of(Ruth, Daniel), AppointmentLength.FIFTEEN, 15));
	}
